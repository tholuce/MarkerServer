...
QT_MOC_LITERAL(1, 5, 9), // "SendPictr"
...
static const uint qt_meta_data_Task[] = {
 ...
 // signals: parameters
    QMetaType::Int, QMetaType::QString, QMetaType::QByteArray,    2,    2,
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->SendPictr((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2])));
        ...
        {
            typedef int (Task::*_t)(QString , QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Task::SendPictr)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
int Task::SendPictr(QString _t1, QByteArray _t2)
{
    int _t0 = int();
